...
#ifndef NF_REAL_RATIONAL_H
#define NF_REAL_RATIONAL_H
...
/*  Real polynomials found here.                                              */
#include "nf_real_poly.h"

/*  Struct for working with complex rational functions.                       */
struct nf_real_rational {

    /*  A real rational function is the quotient of two polynomials.          */
    struct nf_real_poly num, den;
};

/******************************************************************************
 *  Function:                                                                 *
 *      nf_real_rational_eval                                                 *
 *  Purpose:                                                                  *
 *      Evaluates a rational function at a complex number.                    *
 *  Arguments:                                                                *
 *      rat (const struct nf_real_rational *):                                *
...
nf_real_rational_complex_eval(const struct nf_real_rational *rat,
                              const struct nf_complex *z)
{
    /*  Compute the evaluation for the numerator and denominator.             */
    const struct nf_complex num_z = nf_real_poly_complex_eval(&rat->num, z);
    const struct nf_complex den_z = nf_real_poly_complex_eval(&rat->den, z);

    /*  Divide the two values and return.                                     */
    return nf_complex_divide(&num_z, &den_z);
}
/*  End of nf_real_rational_eval.                                             */

/******************************************************************************
 *  Function:                                                                 *
 *      nf_real_drational_eval                                                *
 *  Purpose:                                                                  *
 ...
 ******************************************************************************/
NF_INLINE struct nf_complex
nf_real_drational_complex_eval(const struct nf_real_rational *rat,
                               const struct nf_complex *z)
{
    /*  Compute the evaluation for the numerator and denominator.             */
    const struct nf_complex num_z = nf_real_poly_complex_eval(&rat->num, z);
    ...
    const struct nf_complex dnum_z = nf_real_dpoly_complex_eval(&rat->num, z);
    const struct nf_complex dden_z = nf_real_dpoly_complex_eval(&rat->den, z);
