 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Generates a Newton fractal for p(z) = z^3 - z^2 - 1.                  *
 ******************************************************************************
 *  Author: Ryan Maguire                                                      *
 *  Date:   2023/05/06                                                        *
 ******************************************************************************/
...
/*  Routine for plotting the Newton fractal for z^3 - z^2 - 1.                */
int main(void)
{
    /*  The coefficients for the polynomial p(z) = -1 - z^2 + z^3.            */
    double coeffs[4] = {-1.0, 0.0, -1.0, 1.0};

    /*  Name of the output PPM file.                                          */
    const char *name = "newton_fractal_z3_minus_z2_minus_one.ppm";
