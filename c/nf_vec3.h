 ...
 ******************************************************************************/
NF_INLINE struct nf_vec3
nf_vec3_normalize(const struct nf_vec3 *v)
{
    /*  Variable for the output.                                              */
    struct nf_vec3 v_hat;

    /*  Save a potentially wasteful square root, compute ||v||^2.             */
    const double norm_sq = nf_vec3_normsq(v);
...
/*  End of nf_vec3_normalize.                                                 */


/******************************************************************************
 *  Function:                                                                 *
 *      nf_vec3_normalizeself                                                 *
 *  Purpose:                                                                  *
 *      Normalizes a vector to unit length.                                   *
 *  Arguments:                                                                *
 *      v (struct nf_vec3 *):                                                 *
 ...
 ******************************************************************************/
NF_INLINE void
nf_vec3_normalizeself(struct nf_vec3 *v)
{
    /*  Save a potentially wasteful square root, compute ||v||^2.             */
    const double norm_sq = nf_vec3_normsq(v);
